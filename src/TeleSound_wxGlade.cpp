    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    sizerPanel->Add(0, 0, 0, 0, 0);
    sizerPanel->Add(20, 20, 0, 0, 0);
    ...
    wxStaticBoxSizer* sizer_5 = new wxStaticBoxSizer(new wxStaticBox(page2, wxID_ANY, wxT("Sygnał mowy")), wxVERTICAL);
