    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    notebookWindow->AddPage(page6, wxT("Modulacja"));
    wxBoxSizer* sizer_1 = new wxBoxSizer(wxVERTICAL);
    wxStaticBoxSizer* sizer_21 = new wxStaticBoxSizer(new wxStaticBox(page6, wxID_ANY, wxT("Wybór modulacji")), wxHORIZONTAL);
    ...
    combo_box_1 = new wxComboBox(page6, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, 4, combo_box_1_choices, wxCB_DROPDOWN|wxCB_READONLY);
    combo_box_1->SetSelection(1);
    sizer_21->Add(combo_box_1, 1, 0, 0);
    wxStaticBoxSizer* sizer_19 = new wxStaticBoxSizer(new wxStaticBox(page6, wxID_ANY, wxT("Modulator")), wxVERTICAL);
    sizer_1->Add(sizer_19, 1, wxEXPAND, 0);
    ...
    wxStaticBoxSizer* sizer_23 = new wxStaticBoxSizer(new wxStaticBox(page6, wxID_ANY, wxT("Parametry modulatora")), wxVERTICAL);
    sizer_19->Add(sizer_23, 1, wxEXPAND, 0);
    wxGridSizer* grid_sizer_1 = new wxGridSizer(3, 2, 2, 0);
    sizer_23->Add(grid_sizer_1, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 0);
    wxStaticText* label_3 = new wxStaticText(page6, wxID_ANY, wxT("N_symb:"));
    grid_sizer_1->Add(label_3, 0, 0, 0);
    text_ctrl_1 = new wxTextCtrl(page6, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY);
    grid_sizer_1->Add(text_ctrl_1, 0, 0, 0);
    wxStaticText* label_7 = new wxStaticText(page6, wxID_ANY, wxT("f_symb"));
    grid_sizer_1->Add(label_7, 0, 0, 0);
    text_ctrl_2 = new wxTextCtrl(page6, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY);
    grid_sizer_1->Add(text_ctrl_2, 0, 0, 0);
    wxStaticText* label_8 = new wxStaticText(page6, wxID_ANY, wxT("bit_per_sample"));
    grid_sizer_1->Add(label_8, 0, 0, 0);
    text_ctrl_3 = new wxTextCtrl(page6, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY);
    grid_sizer_1->Add(text_ctrl_3, 0, 0, 0);
    ...
    sizer_23->Add(grid_sizer_2, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 0);
    wxStaticText* label_4 = new wxStaticText(page6, wxID_ANY, wxT("T_symb"));
    grid_sizer_2->Add(label_4, 0, 0, 0);
    text_ctrl_4 = new wxTextCtrl(page6, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY);
    grid_sizer_2->Add(text_ctrl_4, 0, 0, 0);
    wxStaticText* label_5 = new wxStaticText(page6, wxID_ANY, wxT("F_symb"));
    grid_sizer_2->Add(label_5, 0, 0, 0);
    text_ctrl_5 = new wxTextCtrl(page6, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY);
    grid_sizer_2->Add(text_ctrl_5, 0, 0, 0);
    wxStaticText* label_6 = new wxStaticText(page6, wxID_ANY, wxT("bps"));
    grid_sizer_2->Add(label_6, 0, 0, 0);
    text_ctrl_6 = new wxTextCtrl(page6, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY);
    grid_sizer_2->Add(text_ctrl_6, 0, 0, 0);
    ...
    wxStaticText* label_1 = new wxStaticText(page6, wxID_ANY, wxT("Częstotliwość nośna (f_o / F_o):"));
    ...
    CarrierFreqSlider->SetToolTip(wxT("Wybór częstotliwości nośnej"));
    sizer_23->Add(CarrierFreqSlider, 0, wxEXPAND, 0);
    wxStaticBoxSizer* sizer_20 = new wxStaticBoxSizer(new wxStaticBox(page6, wxID_ANY, wxT("Demodulator")), wxVERTICAL);
    sizer_1->Add(sizer_20, 1, wxEXPAND, 0);
