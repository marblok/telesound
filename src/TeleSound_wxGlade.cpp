// -*- C++ -*-
//
// generated by wxGlade 1.0.4 on Tue Oct 31 22:34:07 2023
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    wxglade_tmp_menu->Append(ID_Lang_PL, wxT("PL"), wxEmptyString, wxITEM_RADIO);
    Bind(wxEVT_MENU, &GUIFrame::OnLanguageChange, this, ID_Lang_PL);
    wxglade_tmp_menu->Append(ID_Lang_EN, wxT("ENG"), wxEmptyString, wxITEM_RADIO);
    Bind(wxEVT_MENU, &GUIFrame::OnLanguageChange, this, ID_Lang_EN);
    frame_menubar->Append(wxglade_tmp_menu, wxT("Language"));
    ...
    ResetSettingsButton->SetToolTip(wxT("Przywróć ustawienia domyślne"));
    ...
    wxStaticText* SamplingRateST = new wxStaticText(page1, wxID_ANY, wxT("Szybkość próbkowania:"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT);
    ...
    sizer_21->Add(ModulationTypeBox, 1, 0, 0);
    ...
    wxGridSizer* grid_sizer_1 = new wxGridSizer(4, 2, 2, 0);
    sizer_23->Add(grid_sizer_1, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 0);
    wxStaticText* label_9 = new wxStaticText(page6, wxID_ANY, wxT("Wariant: "));
    grid_sizer_1->Add(label_9, 0, wxBOTTOM|wxTOP, 3);
    ...
    grid_sizer_1->Add(ModulatorVariantSelect, 0, wxBOTTOM|wxTOP, 3);
