// -*- C++ -*-
//
// generated by wxGlade 1.0.4 on Tue Nov  7 16:10:01 2023
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    wxglade_tmp_menu->Append(ID_Lang_PL, _("PL"), wxEmptyString, wxITEM_RADIO);
    Bind(wxEVT_MENU, &GUIFrame::OnLanguageChange, this, ID_Lang_PL);
    wxglade_tmp_menu->Append(ID_Lang_EN, _("ENG"), wxEmptyString, wxITEM_RADIO);
    ...
    wxStaticText* label_9 = new wxStaticText(page6, wxID_ANY, _("Wariant: "));
