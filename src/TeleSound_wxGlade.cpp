// -*- C++ -*-
//
// generated by wxGlade 1.0.4 on Fri Nov 17 21:15:23 2023
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    wxStaticText* label_10 = new wxStaticText(page6, wxID_ANY, _("Szybkoscprobkowania nie jest wielokrotnoscia kości symbolowej!"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
    ...
    sizer_20->Add(label_11, 1, wxTOP, 3);
    ...
    wxStaticText* label_12 = new wxStaticText(page6, wxID_ANY, _("Korekta fazy (Sa):"));
    sizer_20->Add(label_12, 1, wxTOP, 3);
    DemodCarrierOffset = new wxSlider(page6, ID_demod_carrieroffset_SLIDER, 0, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS);
    DemodCarrierOffset->SetToolTip(_("Korekta fazy"));
    DemodCarrierOffset->Enable(0);
    sizer_20->Add(DemodCarrierOffset, 0, wxALL|wxEXPAND, 3);
