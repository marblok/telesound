// -*- C++ -*-
//
// generated by wxGlade 1.0.4 on Fri Nov 17 23:33:29 2023
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    sizer_20->Add(sizer_26, 1, wxEXPAND, 0);
    wxStaticText* label_13 = new wxStaticText(page6, wxID_ANY, _("0"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
    sizer_26->Add(label_13, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 3);
    DemodCarrierOffset = new wxSlider(page6, ID_demod_carrieroffset_SLIDER, 0, 0, 100);
    DemodCarrierOffset->SetToolTip(_("Korekta fazy"));
    DemodCarrierOffset->Enable(0);
    sizer_26->Add(DemodCarrierOffset, 1, wxALL|wxEXPAND, 3);
